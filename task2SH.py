...
def test(resnet50, model, test_loader, device, file_name):
    with open(file_name+'p2_result.txt', 'w', newline='') as csvfile:
...
def main():
    ...
    load_checkpoint('task2-Model-438.pth', model, 111)
    ...
    #loader
    print('doading datas')
    testset = task2Loader.TRIMMED(sys.argv[1], sys.argv[2], transforms.Compose([transforms.ToTensor(),transforms.Normalize((0.485, 0.456, 0.406),(0.229,0.224,0.225))]))
